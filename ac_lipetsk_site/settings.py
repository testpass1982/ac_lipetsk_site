"""
Django settings for ac_lipetsk_site project.
...
SECRET_KEY = '6a&a5bab2j3&f24if0=vnik0g)+18k99a+q27y2jfk$h%^onyd'
...
ROOT_URLCONF = 'ac_lipetsk_site.urls'
...
WSGI_APPLICATION = 'ac_lipetsk_site.wsgi.application'
